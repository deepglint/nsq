...
var (
	...
	topic         = flag.String("topic", "fast", "NSQ topic")
	channel       = flag.String("channel", "fastch", "NSQ channel")
...
func (th *TailHandler) HandleMessage(m *nsq.Message) error {
	...
	//	log.Fatalf("ERROR: failed to write to os.Stdout - %s", err)
	//}
	if th.messagesShown%10 == 0 {
		os.Stdout.WriteString(strconv.Itoa(th.messagesShown))
